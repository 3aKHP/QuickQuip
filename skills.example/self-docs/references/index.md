...
- `docs/admin/global-admins.md` → `references/docs-admin-global-admins.md` — 全局管理员 ｜ 关键词：config/admins.toml、config/admins.example.toml、ADMIN_TRACE、registry_loaded、global_admin_unlock、.env、SUPERUSERS
